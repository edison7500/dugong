...
class EprintFilterSet(django_filters.FilterSet):
    ...
    author = django_filters.CharFilter(field_name="authors", method="filter_contains")
    keyword = django_filters.CharFilter(field_name="keywords", method="filter_contains")
