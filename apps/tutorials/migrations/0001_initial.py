    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', editormd.models.EditorMdField(blank=True, null=True)),
                ('origin_link', models.URLField(max_length=255, null=True, unique=True, verbose_name='origin_link')),
                ...
                ('author', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='tutorial', to=settings.AUTH_USER_MODEL)),
            ],
            options={
